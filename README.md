...
The **Museum With No Frontiers — Metalwork** gallery, built from the published
dataset `@museumwnf/metalwork-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/metalwork-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/metalwork/> through the reusable workflows in
