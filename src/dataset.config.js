...
export default {
  ...
  home: {
    title: 'metalwork.identity.title',
    intro: 'metalwork.home.intro',
    cards: [
      {
        title: 'metalwork.nav.catalogue',
        description: 'metalwork.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'metalwork.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'metalwork.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'metalwork.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'metalwork.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'metalwork.partnerObjects.emptyPartner',
  //         emptyInstitution: 'metalwork.partnerObjects.emptyInstitution',
  //         institutionSummary: 'metalwork.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'metalwork.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'metalwork.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
