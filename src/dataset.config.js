...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/metalwork-data`
  // carries in `manifest.projects` (checked 2026-09-19, metalwork-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/metalwork' },
