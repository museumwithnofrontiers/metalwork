...
// `useGalleryData.js` used to be byte-identical local copies of what metalwork
...
// legacy project key, no UUID — metalwork shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (metalwork-data 1.0.11+), an outside
